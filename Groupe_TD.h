...
public:
	...
	void setEtudiantsPresence(bool present, int i) { tabMembre_[i]->setPresence(present); } // modifie le bool indiquant la presence 
	// de l'élève d'indice i en bool present
