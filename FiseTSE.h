...
class FiseTSE 
{
	...
	vector<string> numero_, username_, nom_, prenom_, groupe_TD_, image_; // vecteur numero_ contient tout les numeros du fichier, 
	// même principe pour les autres vecteurs
public:
	...
	string afficherInfosVecteurs(string nom_vecteur, int i); // return nom_vecteur[i] (ex : prenom_[3] le prenom de l'etudiant numéro 4)
